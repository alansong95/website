...
<html lang="en">
    <head>
        ...
        <title>Exploration Robot - Documentation - Alan W. Song</title>
    </head>
    <body>     
        <div class="container">
            <?php
            ...
            <div class="row">
                ...
                <script>
                    ...
                    $('div#side_nav_exploration_robot > div.collapse').attr('id', 'open');
                    $('div#side_nav_exploration_robot > div.collapse > a.doc').attr('id', 'side_active');
                </script>
