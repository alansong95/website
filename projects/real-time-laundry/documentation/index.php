...
<html lang="en">
    <head>
        ...
        <title>Real Time Laundry - Documentation - Alan W. Song</title>
    </head>
    <body>     
        <div class="container">
            <?php
            ...
            <div class="row">
                ...
                <script>
                    ...
                    $('div#side_nav_real_time_laundry > div.collapse').attr('id', 'open');
                    $('div#side_nav_real_time_laundry > div.collapse > a.doc').attr('id', 'side_active');
                </script>
